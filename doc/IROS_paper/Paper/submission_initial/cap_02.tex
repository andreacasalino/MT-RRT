...
\begin{figure}
	\centering
\subfloat[]{\includegraphics[width=0.2\textwidth]{Immagini/pdf/Steer_01.pdf} \label{fig:Extend_01}} \quad
\subfloat[]{\includegraphics[width=0.2\textwidth]{Immagini/pdf/Steer_02.pdf} \label{fig:Extend_02}}
