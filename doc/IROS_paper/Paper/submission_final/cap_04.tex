...
\begin{figure}
	\centering
\subfloat[]{\includegraphics[width=0.2\textwidth]{Immagini/pdf/Problem_A_01.eps} \label{fig:Problem_A_01}} \quad
\subfloat[]{\includegraphics[width=0.2\textwidth]{Immagini/pdf/Problem_A_02.eps} \label{fig:Problem_A_02}} \\
\subfloat[]{\includegraphics[width=0.2\textwidth]{Immagini/pdf/Problem_A_03.eps} \label{fig:Problem_A_03}} \quad
\subfloat[]{\includegraphics[width=0.2\textwidth]{Immagini/pdf/Problem_A_04.eps} \label{fig:Problem_A_04}}
...
%\begin{figure}
%	\centering
%\subfloat[]{\includegraphics[width=0.2\textwidth]{Immagini/pdf/problem_B_01.eps}} \quad
%\subfloat[]{\includegraphics[width=0.2\textwidth]{Immagini/pdf/problem_B_02.eps}}
...
\begin{figure*}
	\centering
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_1_1.eps}} \quad
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_1_2.eps}} \quad
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_1_3.eps}} 
\caption{Performance obtained adopting the strategy described in Section \ref{subsec:MT_01}.}
\label{fig:res_parall_query}
\end{figure*}
\begin{figure*}
	\centering
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_2_1.eps}} \quad
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_2_2.eps}} \quad
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_2_3.eps}} 
\caption{Performance obtained adopting the strategy described in Section \ref{subsec:MT_02}.}
\label{fig:res_shared}
\end{figure*}
\begin{figure*}
	\centering
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_3_1.eps}} \quad
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_3_2.eps}} \quad
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_3_3.eps}} 
\caption{Performance obtained adopting the strategy described in Section \ref{subsec:MT_03}.}
\label{fig:res_copied}
\end{figure*}
\begin{figure*}
	\centering
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_4_1.eps}} \quad
\subfloat[]{\includegraphics[width=0.31\textwidth]{Immagini/pdf/time_4_3.eps}} \quad
\subfloat[]{\includegraphics[width=0.15\textwidth]{Immagini/pdf/result_legenda.pdf}}
