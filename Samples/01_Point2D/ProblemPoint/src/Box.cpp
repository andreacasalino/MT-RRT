...
namespace mt::sample {
	...
	std::list<Box> Box::generateRandomBoxes(const size_t& N_cl, const size_t& N_box) {
		...
		UniformRandomEngine samplerPos(0.f , 1.f);
		UniformRandomEngine samplerRadius(0.01f, 0.08f);
		UniformRandomEngine samplerAngle(10.f * 3.141f / 180.f, 80.f * 3.141f / 180.f);
